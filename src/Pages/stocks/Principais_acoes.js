...
function PA() {
  ...
  ///⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩  API POR AÇÃO  ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩
    ...
    async function APIGET() {
      ...
      //⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩  PEPSI  ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩
      let response3 = await fetch("https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=PEP&apikey=GL7OCY3JYIA7LDPG");
      ...
      if(stock3_gain >= 0) {var stock3 = <><div className='stock-div-price'>$ {stock3_price}</div><div className='gain-variation1'><div className='stock-div-gain'>{stock3_gain}</div><div>({stock3_variation}%)</div></div></>}
      else{var stock3 = <><div className='stock-div-price'>$ {stock3_price}</div><div className='gain-variation2'><div className='stock-div-gain'>{stock3_gain}</div><div>({stock3_variation}%)</div></div></>}
      setStock3(stock3);
          ...
          <div class="container text-center">
            ...
            <div class="col-md-auto">
              ...
              <div className='stock'>
                ...
                <div>
                  <img className='img-stock' src="https://www.freepnglogos.com/uploads/pepsi-png-logo/pepsi-logo-pepsi-symbol-meaning-history-png-logo-3.png"></img>
                </div>
              </div>
              <div className='stock'>
                <div className='stock-esquerda'>
