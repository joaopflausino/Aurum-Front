  ...
  return (
    <HashRouter>
      <Switch>
        ...
        <RotaAutenticada isAutenticado={props.isUsuarioAutenticado} path="/adicionar-investimento" component={AddInvestment} />
        ...
        <RotaAutenticada isAutenticado={props.isUsuarioAutenticado} path="/meus-investimentos" component={MyInvestments} />
      </Switch>
    </HashRouter>
  )
}
